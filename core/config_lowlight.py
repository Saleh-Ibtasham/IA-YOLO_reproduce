...
parser.add_argument('--train_path', dest='train_path', nargs='*', default='C:/Users/niloy/Desktop/lab_assignment_3/Image-Adaptive-YOLO/data/dataset_dark/voc_norm_train.txt', help='folder of the training data')
parser.add_argument('--test_path', dest='test_path', nargs='*', default='C:/Users/niloy/Desktop/lab_assignment_3/Image-Adaptive-YOLO/data/dataset_dark/exdark_test.txt', help='folder of the training data')
parser.add_argument('--class_name', dest='class_name', nargs='*', default='C:/Users/niloy/Desktop/lab_assignment_3/Image-Adaptive-YOLO/data/classes/vocdark.names', help='folder of the training data')
parser.add_argument('--WRITE_IMAGE_PATH', dest='WRITE_IMAGE_PATH', nargs='*', default='C:/Users/niloy/Desktop/lab_assignment_3/Image-Adaptive-YOLO/experiments_lowlight/exp_58/detection_vocnorm_test/', help='folder of the training data')
parser.add_argument('--WEIGHT_FILE', dest='WEIGHT_FILE', nargs='*', default='C:/Users/niloy/Desktop/lab_assignment_3/Image-Adaptive-YOLO/experiments_lowlight/exp_58/checkpoint/yolov3_test_loss=9.7815.ckpt-62', help='folder of the training data')
