...
parser.add_argument('--vocfog_traindata_dir', dest='vocfog_traindata_dir', default='C:/Users/niloy/Desktop/lab_assignment_3/Image-Adaptive-YOLO/data/vdd/data_vocfog/train/JPEGImages/',
                    help='the dir contains ten levels synthetic foggy images')
parser.add_argument('--vocfog_valdata_dir', dest='vocfog_valdata_dir', default='C:/Users/niloy/Desktop/lab_assignment_3/Image-Adaptive-YOLO/data/vdd/data_vocfog/val/JPEGImages/',
                    help='the dir contains ten levels synthetic foggy images')
parser.add_argument('--train_path', dest='train_path', nargs='*', default='C:/Users/niloy/Desktop/lab_assignment_3/Image-Adaptive-YOLO/data/dataset_fog/voc_norm_train.txt', help='folder of the training data')
parser.add_argument('--val_path', dest='val_path', nargs='*', default='C:/Users/niloy/Desktop/lab_assignment_3/Image-Adaptive-YOLO/data/dataset_fog/voc_norm_test.txt', help='folder of the training data')
parser.add_argument('--test_path', dest='test_path', nargs='*', default='C:/Users/niloy/Desktop/lab_assignment_3/Image-Adaptive-YOLO/data/dataset_fog/RTTS_test.txt', help='folder of the training data')
parser.add_argument('--class_name', dest='class_name', nargs='*', default='C:/Users/niloy/Desktop/lab_assignment_3/Image-Adaptive-YOLO/data/classes/vocfog.names', help='folder of the training data')
